...
class Patient(AbstractAuditModel):
    ...
    discharge_date = models.DateTimeField(_('discharge date'), null=True)
    ...
    user = models.OneToOneField(settings.AUTH_USER_MODEL, verbose_name=_('user'), null=True,
    ...
    attending_staff = models.ManyToManyField('staff.Staff', related_name='staff_patient_set',
                                             verbose_name=_('attending staff'))
